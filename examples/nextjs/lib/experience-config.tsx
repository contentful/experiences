 ...
 * `component` / `experienceTemplate`. Components style themselves from their
 * auto-filled design props; `resolveToken` is what turns design-token ids into
 * the values those props carry.
 *
