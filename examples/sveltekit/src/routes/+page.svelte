...
>
  <h1 style="margin-top: 0;">Contentful Experiences — SvelteKit example</h1>
  ...
  <p style="color: #4b5563;">
    Without <code>CDA_TOKEN</code> set in <code>.env</code>, the app uses a built-in mock payload so it
